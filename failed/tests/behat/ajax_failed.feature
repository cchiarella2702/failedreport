@gradereport @gradereport_failed
Feature: Using the AJAX grading feature of Failed report to update grades and feedback
  ...
  @javascript
  Scenario: Use the failed report without editing, with AJAX on and quick feedback off
    When the following config values are set as admin:
      | grade_overridecat | 1 |
      | grade_report_showquickfeedback | 0 |
    And I log in as "teacher1"
    And I follow "Course 1"
    And I navigate to "View > failed report" in the course gradebook
  ...
  @javascript
  Scenario: Use the failed report without editing, with AJAX and quick feedback on
    When the following config values are set as admin:
      | grade_overridecat | 1 |
  ...
  @javascript
  Scenario: Use the failed report without editing, with AJAX and quick feedback on, without category override
    When the following config values are set as admin:
      | grade_overridecat | 0 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
  ...
  @javascript
  Scenario: Use the failed report with editing, with AJAX and quick feedback on, with category override
    When the following config values are set as admin:
      | grade_overridecat | 1 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
  ...
  @javascript
  Scenario: Use the failed report with editing, with AJAX and quick feedback on, without category override
    When the following config values are set as admin:
      | grade_overridecat | 0 |
      | grade_report_showquickfeedback | 1 |
    And I log in as "teacher1"
