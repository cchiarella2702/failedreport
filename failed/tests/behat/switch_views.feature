...
Feature: We can change what we are viewing on the failed report
  ...
  @javascript
  Scenario: View and minimise the failed report containing hidden activities
    And I follow "Course 1"
    And I turn editing mode on
  ...
  @javascript
  Scenario: View and minimise the failed report containing hidden activities without the 'moodle/grade:viewhidden' capability
    And I follow "Course 1"
    And I turn editing mode on
    And I open "Test assignment name 2" actions menu
    And I click on "Hide" "link" in the "Test assignment name 2" activity
